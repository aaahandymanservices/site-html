        ...
        '<div class="lg:sticky" style="top: var(--sticky-offset, 160px);">' +
          '<div class="bg-blue-950 text-white rounded-3xl p-7 shadow-2xl">' +
            ...
            '<div class="mt-6 space-y-3">' +
              ...
              '<a href="tel:+12483853432" class="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold px-5 py-3.5 rounded-xl transition">' +
