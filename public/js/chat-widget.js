(function () {
  ...
  style.textContent = [
    ...
    ".aaa-chat-log::-webkit-scrollbar-thumb{background:#cbd6e2;border-radius:3px}",
    ".aaa-chat-log::-webkit-scrollbar-thumb:hover{background:#9fb1ca}",
    ...
    ".aaa-chat-form textarea{flex:1;resize:none;border:1px solid #c3cfde;border-radius:12px;padding:10px 12px;font-family:inherit;font-size:14px;line-height:1.4;max-height:120px;color:#0d2237;transition:border-color .15s ease,box-shadow .15s ease}",
    ".aaa-chat-form textarea:focus{outline:none;border-color:" + CRIMSON + ";box-shadow:0 0 0 3px rgba(142,31,38,0.15)}",
    ...
    ".dark .aaa-chat-header p{color:#9fb1ca;opacity:1}",
    ...
    ".dark .aaa-typing span{background:#5776a2}",
    ".dark .aaa-chat-prompts{background:#0a1b2c;border-top-color:#1B2A4A}",
    ".dark .aaa-chat-prompts-label{color:#5776a2}",
    ".dark .aaa-chat-prompt{background:#0d2237;color:#fff;border-color:#1B2A4A}",
    ".dark .aaa-chat-prompt:hover:not(:disabled){background:#1B2A4A;border-color:" + CRIMSON + ";color:#fff}",
    ".dark .aaa-chat-emoji-bar{background:#0a1b2c;border-top-color:#1B2A4A}",
    ".dark .aaa-chat-emoji{background:#0d2237;border-color:#1B2A4A}",
    ".dark .aaa-chat-emoji:hover{background:#1B2A4A;border-color:#9fb1ca}",
    ...
    ".dark .aaa-chat-emoji-trigger{background:#0d2237;border-color:#1B2A4A;color:#cbd6e2}",
    ".dark .aaa-chat-emoji-trigger:hover,.dark .aaa-chat-emoji-trigger[aria-expanded='true']{background:#1B2A4A;color:#fff}",
    ".dark .aaa-chat-disclaimer{background:#0a1b2c;color:#5776a2}",
    ".dark .aaa-chat-bubble{background:#0a1b2c;color:#fff;border-color:#1B2A4A;box-shadow:0 10px 30px rgba(3,7,11,0.4)}",
    ".dark .aaa-chat-bubble-arrow{background:#0a1b2c;border-right-color:#1B2A4A;border-bottom-color:#1B2A4A}",
    ".dark .aaa-chat-bubble-close{color:#5776a2}",
    ".dark .aaa-chat-bubble-close:hover{color:#fb923c}",
    ".dark .aaa-chat-log::-webkit-scrollbar-thumb{background:#1B2A4A}",
    ".dark .aaa-chat-log::-webkit-scrollbar-thumb:hover{background:#5776a2}",
