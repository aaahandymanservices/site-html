(function () {
  ...
  style.textContent = [
    ...
    ".aaa-chat-launch{background:" + CRIMSON + ";box-shadow:0 10px 25px -5px rgba(166,31,46,0.35)}",
    ...
    ".aaa-chat-panel{position:fixed;bottom:92px;right:20px;z-index:2147483000;width:380px;max-width:calc(100vw - 32px);height:580px;max-height:calc(100vh - 120px);background:#ffffff;border:1px solid #cbd5e1;box-shadow:0 20px 45px -10px rgba(15,23,42,0.3),0 0 15px rgba(0,0,0,0.05);border-radius:20px;display:none;flex-direction:column;overflow:hidden;font-family:'Roboto','Archivo',system-ui,-apple-system,sans-serif}",
    ".aaa-chat-panel.aaa-open{display:flex;animation:aaa-pop .2s cubic-bezier(.16,1,.3,1)}",
    "@keyframes aaa-pop{from{opacity:0;transform:translateY(16px) scale(.97)}to{opacity:1;transform:translateY(0) scale(1)}}",
    ".aaa-chat-header{background:#0f172a;color:#ffffff;padding:16px 18px;display:flex;align-items:center;gap:12px;border-bottom:3px solid " + CRIMSON + "}",
    ".aaa-chat-header .aaa-avatar{width:42px;height:42px;border-radius:9999px;background:" + CRIMSON + ";display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;border:2px solid rgba(255,255,255,.9);box-shadow:0 2px 8px rgba(0,0,0,.25)}",
    ".aaa-chat-header .aaa-avatar img{width:100%;height:100%;display:block;object-fit:cover}",
    ".aaa-chat-header h2{margin:0;font-family:'Archivo','Roboto',system-ui,-apple-system,sans-serif;font-size:15px;font-weight:700;line-height:1.2;color:#ffffff}",
    ".aaa-chat-header p{margin:3px 0 0;font-size:12px;color:#94a3b8;line-height:1.2}",
    ".aaa-chat-header-actions{margin-left:auto;display:flex;align-items:center;gap:6px}",
    ".aaa-chat-control-btn{background:none;border:none;color:#ffffff;font-size:16px;cursor:pointer;opacity:.85;padding:6px;line-height:1;display:flex;align-items:center;justify-content:center;border-radius:8px;transition:opacity .15s,background-color .15s,color .15s}",
    ".aaa-chat-control-btn:hover{opacity:1;background-color:rgba(255,255,255,0.15);color:#ffffff}",
    ...
    ".aaa-msg{max-width:100%;padding:10px 14px;border-radius:16px;font-size:14px;line-height:1.5;white-space:pre-wrap;word-wrap:break-word}",
    ".aaa-msg.aaa-user{background:" + CRIMSON + ";color:#ffffff;border-bottom-right-radius:4px;box-shadow:0 2px 6px rgba(166,31,46,.2)}",
    ".aaa-msg.aaa-bot{background:#ffffff;color:#0f172a;border:1px solid #e2e8f0;border-bottom-left-radius:4px;box-shadow:0 1px 3px rgba(15,23,42,.05)}",
    ".aaa-msg.aaa-bot a{color:" + CRIMSON + ";font-weight:600;text-decoration:underline}",
    ...
    ".aaa-chat-prompt{flex:0 0 auto;max-width:230px;border:1px solid #cbd5e1;border-radius:9999px;background:#f8fafc;color:#0f172a;padding:7px 12px;font:600 12px/1.2 'Roboto',system-ui,-apple-system,sans-serif;cursor:pointer;white-space:nowrap;transition:all .15s ease}",
    ".aaa-chat-prompt:hover:not(:disabled){background:#0f172a;color:#ffffff;border-color:#0f172a;transform:translateY(-1px);box-shadow:0 2px 6px rgba(15,23,42,.15)}",
    ...
    ".aaa-chat-emoji{flex:0 0 auto;width:34px;height:34px;border:1px solid #cbd5e1;border-radius:8px;background:#ffffff;font-size:18px;line-height:1;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .15s ease}",
    ...
    ".aaa-chat-form textarea{flex:1;resize:none;background:#f8fafc;border:2px solid #e2e8f0;border-radius:12px;padding:10px 12px;font-family:inherit;font-size:14px;line-height:1.4;max-height:120px;color:#0f172a;transition:border-color .15s ease,box-shadow .15s ease,background-color .15s ease}",
    ...
    ".aaa-chat-emoji-trigger{flex-shrink:0;width:42px;height:42px;border-radius:12px;border:2px solid #e2e8f0;background:#f8fafc;color:#475569;font-size:18px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .15s ease}",
    ...
    ".aaa-chat-send{flex-shrink:0;width:42px;height:42px;border-radius:12px;border:none;background:" + CRIMSON + ";color:#ffffff;font-size:15px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background-color .15s ease,transform .15s ease,box-shadow .15s ease;box-shadow:0 2px 6px rgba(166,31,46,.25)}",
    ".aaa-chat-send:hover:not(:disabled){background:#781925;transform:scale(1.03)}",
