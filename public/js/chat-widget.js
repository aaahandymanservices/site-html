(function () {
  ...
  style.textContent = [
    ...
    ".aaa-chat-control-btn:focus-visible{outline:none !important;box-shadow:0 0 0 3px rgba(255,255,255,.85) !important}",
    ...
    ".aaa-chat-send:hover:not(:disabled){background:#781925}",
