(function () {
  ...
  const initDarkMode = () => {
    ...
    toggleBtn.className = 'text-blue-900 hover:text-red-600 dark:text-gray-100 dark:hover:text-red-400 focus:outline-none focus:ring-0 focus:ring-transparent focus-visible:outline-none focus-visible:ring-0 p-2 text-xl sm:text-2xl mr-2 transition-colors';
