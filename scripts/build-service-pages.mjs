        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid gap-10 md:grid-cols-3 md:gap-8 text-center md:text-left">
                ...
                <div>
                    ...
                    <a href="/book?service=${enc(service.formService)}" data-plain-booking-link class="mt-5 inline-flex items-center gap-3 hover:text-white transition"><i class="fas fa-calendar-check" aria-hidden="true"></i>Book Online Now</a>
                </div>
            </div>
