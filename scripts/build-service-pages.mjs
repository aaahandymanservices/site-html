        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid gap-10 md:grid-cols-3 md:gap-8 text-center md:text-left">
                <div class="flex flex-col items-center md:items-start">
                    ...
                    <p class="text-xs font-bold uppercase tracking-wider text-red-500 mb-2">AAA: Anytime. Anywhere. Anything</p>
                ...
                <nav aria-label="Footer Navigation">
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="/book" data-plain-booking-link class="hover:text-white transition">Book Online</a></li>
                ...
                <div>
                    ...
                    <a href="/book?service=${enc(service.formService)}" data-plain-booking-link class="mt-5 inline-flex items-center gap-3 text-sm hover:text-white transition"><i class="fas fa-calendar-check w-4 text-center" aria-hidden="true"></i>Book Online Now</a>
                </div>
            </div>

            <div class="mt-12 pt-8 border-t border-gray-800 text-center">
                <p class="text-xs leading-relaxed">&copy; 2026 AAA Handyman Services LLC All Rights Reserved.<br>Locally Serving Oakland County, MI.</p>
