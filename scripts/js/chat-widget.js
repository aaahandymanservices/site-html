(function () {
  ...
  style.textContent = [
    ...
    ".aaa-chat-form{box-sizing:border-box;width:100%;border-top:1px solid #e2e8f0;padding:12px 14px;display:flex;gap:10px;align-items:flex-end;background:#ffffff}",
    ".aaa-chat-input-box{flex:1;display:flex;align-items:flex-end;background:#f8fafc;border:2px solid #e2e8f0;border-radius:18px;padding:3px 6px 3px 14px;box-sizing:border-box;min-height:44px;transition:border-color .15s ease,box-shadow .15s ease,background-color .15s ease}",
    ".aaa-chat-input-box:focus-within{outline:none;background:#ffffff;border-color:" + CRIMSON + ";box-shadow:0 0 0 3px rgba(166,31,46,0.2)}",
    ".aaa-chat-form textarea{flex:1;resize:none;background:transparent;border:none;outline:none;padding:8px 4px 8px 0;margin:0;font-family:inherit;font-size:14px;line-height:1.4;max-height:120px;color:#0f172a;box-shadow:none}",
    ".aaa-chat-form textarea::placeholder{color:#94a3b8}",
    ".aaa-chat-emoji-trigger{flex-shrink:0;box-sizing:border-box;width:34px;height:34px;margin-bottom:3px;border:none;border-radius:10px;background:transparent;color:#64748b;font-size:18px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .15s ease}",
    ".aaa-chat-emoji-trigger:hover,.aaa-chat-emoji-trigger[aria-expanded='true']{background:rgba(166,31,46,0.08);color:" + CRIMSON + "}",
    ".aaa-chat-emoji-trigger:focus-visible{outline:none;box-shadow:0 0 0 2px " + CRIMSON + "}",
    ".aaa-chat-send{flex-shrink:0;box-sizing:border-box;width:44px;height:44px;border-radius:50%;border:none;background:linear-gradient(135deg, #c62839, #a61f2e);color:#ffffff;font-size:15px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background-color .15s ease,transform .15s ease,box-shadow .15s ease;box-shadow:0 3px 8px rgba(166,31,46,.3)}",
    ...
    ".dark .aaa-chat-input-box{background:#020817;border-color:#334155}",
    ".dark .aaa-chat-input-box:focus-within{background:#020817;border-color:" + CRIMSON + ";box-shadow:0 0 0 3px rgba(166,31,46,0.35)}",
    ".dark .aaa-chat-form textarea{background:transparent;color:#ffffff}",
    ".dark .aaa-chat-form textarea::placeholder{color:#64748b}",
    ".dark .aaa-chat-emoji-trigger{background:transparent;border-color:transparent;color:#94a3b8}",
    ".dark .aaa-chat-emoji-trigger:hover,.dark .aaa-chat-emoji-trigger[aria-expanded='true']{background:rgba(248,113,113,0.15);color:#f87171}",
    ...
    "@media(max-width:767px){.aaa-fab{left:max(16px,env(safe-area-inset-left,0px));bottom:calc(16px + env(safe-area-inset-bottom,0px));flex-direction:column;gap:12px;align-items:flex-start}.aaa-fab .aaa-fab-btn{min-width:0;width:54px;height:54px;padding:0;border-radius:50%;gap:0;flex:0 0 54px}.aaa-fab .aaa-fab-btn i{font-size:21px;line-height:1}.aaa-fab .aaa-fab-label{display:none!important}.aaa-fab-btn.aaa-chat-launch{display:flex!important}.aaa-chat-panel{position:fixed;top:0;left:0;right:0;bottom:0;width:100%!important;max-width:100%!important;height:100dvh!important;max-height:100dvh!important;border-radius:0!important;border:none!important;z-index:2147483005}.aaa-chat-header{padding:calc(14px + env(safe-area-inset-top,0px)) 14px 12px!important;gap:10px}.aaa-chat-header .aaa-avatar{width:38px;height:38px;flex:0 0 38px}.aaa-chat-header h2{font-size:14px}.aaa-chat-header p{font-size:11px}.aaa-chat-control-btn{font-size:15px;padding:5px}.aaa-chat-control-btn svg{width:16px;height:16px}.aaa-chat-close{font-size:20px}.aaa-chat-log{padding:12px 14px;gap:10px}.aaa-msg{padding:10px 14px;font-size:13.5px}.aaa-msg-avatar{width:24px;height:24px;flex:0 0 24px}.aaa-chat-prompts{padding:8px 12px 6px}.aaa-chat-prompts-label{font-size:9px;margin-bottom:5px}.aaa-chat-prompt{padding:6px 11px;font-size:11.5px}.aaa-chat-emoji-bar{padding:6px 10px}.aaa-chat-emoji{width:30px;height:30px;font-size:16px}.aaa-chat-form{padding:8px 12px;gap:8px}.aaa-chat-input-box{min-height:40px;padding:2px 4px 2px 12px;border-radius:16px}.aaa-chat-form textarea{padding:7px 4px 7px 0;font-size:13.5px}.aaa-chat-emoji-trigger{width:32px;height:32px;margin-bottom:2px}.aaa-chat-emoji-trigger svg{width:17px;height:17px}.aaa-chat-send{flex:0 0 40px;width:40px;height:40px;border-radius:50%;font-size:14px}.aaa-chat-disclaimer{font-size:9px;padding:0 12px calc(8px + env(safe-area-inset-bottom,0px))!important}}",
    "@media(max-width:359px){.aaa-fab .aaa-fab-btn{width:50px;height:50px;flex-basis:50px}.aaa-fab{gap:10px}.aaa-chat-emoji{width:28px;height:28px;font-size:15px}.aaa-chat-form{padding:6px 8px;gap:6px}.aaa-chat-input-box{min-height:36px;padding:1px 3px 1px 10px;border-radius:14px}.aaa-chat-form textarea{padding:6px 3px 6px 0;font-size:13px}.aaa-chat-emoji-trigger{width:28px;height:28px;margin-bottom:2px}.aaa-chat-send{flex:0 0 36px;width:36px;height:36px;font-size:13px;border-radius:50%}}",
  ].join("");
