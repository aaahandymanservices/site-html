(function () {
  ...
  style.textContent = [
    ...
    ".aaa-chat-form{border-top:1px solid #e2e8f0;padding:12px 14px;display:flex;gap:10px;align-items:flex-end;background:#ffffff}",
    ...
    ".aaa-chat-send{flex-shrink:0;box-sizing:border-box;width:44px;height:44px;border-radius:14px;border:none;background:linear-gradient(135deg, #c62839, #a61f2e);color:#ffffff;font-size:15px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background-color .15s ease,transform .15s ease,box-shadow .15s ease;box-shadow:0 3px 8px rgba(166,31,46,.3)}",
