...
function cityFaq(city) {
  ...
  return [
    ...
    },
    {
      ...
      a: `Yes. After-hours emergency service is available 7 days a week for urgent repairs such as leaks or door and window problems that affect home safety or security ($135 first hour / $85 per hour after). Call ${PHONE_DISPLAY} for priority response.`
    }
  ];
}
