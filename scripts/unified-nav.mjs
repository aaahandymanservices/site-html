    ...
    <div class="header-container site-nav__bar max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div class="site-nav__desktop hidden lg:flex items-center">
            ...
            <div class="ml-4 flex items-center gap-2">
                <a href="/book" class="inline-flex items-center justify-center gap-1.5 px-4 py-2 text-xs xl:text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl shadow-md hover:shadow-red-600/30 transition transform hover:-translate-y-0.5">
