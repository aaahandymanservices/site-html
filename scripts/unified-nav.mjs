...
<header id="site-header" class="site-header sticky top-0 z-[100] bg-[#0B0F19]/95 backdrop-blur-md shadow-2xl border-b-[3px] border-red-600 border-t border-white/10">
    <div class="header-container site-nav__bar max-w-7xl mx-auto flex items-center justify-between">
        <a href="/" class="nav-brand brand site-nav__brand group flex items-center gap-3 min-w-0">
            <img src="/.netlify/images?url=/icon.jpg&amp;w=96&amp;fm=avif&amp;q=80" srcset="/.netlify/images?url=/icon.jpg&amp;w=48&amp;fm=avif&amp;q=80 1x, /.netlify/images?url=/icon.jpg&amp;w=96&amp;fm=avif&amp;q=80 2x" width="48" height="48" decoding="async" fetchpriority="high" alt="" class="brand-logo h-9 w-9 sm:h-11 sm:w-11 rounded-full object-cover flex-shrink-0 border-2 border-red-600 shadow-sm transition group-hover:scale-105">
            <div class="brand-text-group brand-text min-w-0">
                <div class="brand-title text-base min-[390px]:text-lg sm:text-xl lg:text-xl xl:text-2xl font-bold tracking-tight text-white leading-tight truncate">
                    <span class="brand-name">AAA Handyman Services</span>
                    <span class="brand-suffix text-red-500">LLC</span>
                </div>
                <span class="brand-location brand-tagline block text-[10px] sm:text-xs text-slate-400 font-medium">Oakland County, Michigan</span>
            </div>
